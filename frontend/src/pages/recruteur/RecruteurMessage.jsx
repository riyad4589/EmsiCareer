...
const RecruteurMessage = () => {
	...
	useEffect(() => {
		if (!user) {
			navigate("/login", { state: { from: "/recruteur/messages" } });
			return;
		}
		if (user.role !== "recruteur") {
			toast.error("Accès réservé aux recruteurs");
			navigate("/");
		}
	}, [user, navigate]);
							...
							<div className="divide-y">
								{conversations.map((conversation) => (
									<button
										...
										onClick={() => navigate(`/recruteur/messages?user=${conversation.user._id}`)}
...
export default RecruteurMessage; 